		 ...
		 $("#reg").validate({
            ...
            submitHandler : function(){
            	if($("#uploadImages").find("img").length == 0 ){
            		...
            		$.ajax({
		                url:"myVoteInfoAction_ajaxCreateVote.do",
		                type: 'post',
		                 data : {
				            "images":$("#images").val(),
				            "myVoteInfo.price":$("#price").val(),
				            "myVoteInfo.pricess":$("#pricess").val(),
				            "myVoteInfo.summary":$("#circlecontent").val(),
				            "myVoteInfo.title":$("#title").val(),
				            "endTime":$("#endTime").val(),
...
<body>
	<jsp:include page="../inc/header.jsp"></jsp:include>
		<div class="main_cont">
			<div class="main" id="min" style="padding-top:42px;">
								...
								<ul class="create_value_ul">	
									...
									<div class="creat-con" style="height: 30px;">
										<input style="width:298px;" name="startTime" id="startTime" type="text"
											...
											readonly="readonly" />&nbsp;-&nbsp;<input style="width:298px;" name="endTime" id="endTime" type="text"
											class="cterat-value1" onfocus="HS_setDate(this)"
											readonly="readonly" />
									</div>
								</div>
								...
								<ul class="create_value_ul">	
									...
									<div class="creat-con" style="height: 30px;">
										<input style="width:298px;" name="myVoteInfo.price" id="price" type="text"
											...
											onafterpaste="this.value=this.value.replace(/[^\d\.\d\d]/g,'')" />&nbsp;-&nbsp;<input style="width:298px;" name="myVoteInfo.pricess" id="pricess" type="text"
											class="cterat-value1"  onkeyup="this.value=this.value.replace(/[^\d\.\d\d]/g,'')" 
											onafterpaste="this.value=this.value.replace(/[^\d\.\d\d]/g,'')" />
									</div>
								</div>
								<div class="create_value">
									<h3>
									...
									<div class="creat-con">
										<textarea name="myVoteInfo.summary" id="circlecontent"
											cols="79"
											style="width: 650px; height: 300px; visibility: hidden;"></textarea>
									</div>
								</div>

...
<script src="js/user_circle.js" type="text/javascript"></script>
        ...
        <div class="profile_center">
           ...
           <div class="profile_nav">
               <ul id='user_profile'>
                   ...
                   <li><a id="active" style="border-left:none; border-right:none;" href="user_circle/<%=request.getParameter("id") %>">他加入的圈子</a></li>

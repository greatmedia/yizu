...
<script src="<%=basePath%>js/profile_vote.js" type="text/javascript"></script>
        ...
        <div class="profile_center">
           ...
           <div class="profile_nav">
               <ul>
                   ...
                   <li><a id="active" style="border-left:none;"href="profit/profile_vote.jsp">我创建的投票</a></li>
			...
			<label id="loading">
                 		 <div class="profile_page" style="text-align: center" >

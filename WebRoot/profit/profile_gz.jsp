...
<script src="js/profile_gz.js" type="text/javascript"></script>
        ...
        <div class="profile_center">
           ...
           <div class="profile_nav">
               <ul>
                   ...
                   <li><a id="active" style="border-left:none; border-right:none;" href="profit/profile_gz.jsp">我关注的商品</a></li>
            ...
            <div class="profile_titer">
               <div class="prof_mine">
                  <div class="prof_mine_t" id="my_gz">
                  </div>
               </div> 
            </div>
			<div id="loading">

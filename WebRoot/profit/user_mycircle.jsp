...
<script src="js/user_mycircle.js" type="text/javascript"></script>
        ...
        <div class="profile_center">
           ...
           <div class="profile_nav">
               <ul>
                   ...
                   <li><a id="active" style="border-left:none;"href="user_mycircle/<%=request.getParameter("id") %>">他创建的圈子</a></li>

...
$.extend($.validator, {
	...
	messages: {
		...
		chineseMaxLength:$.validator.format("Please enter no more than {0} characters.")
	},
	...
	methods: {
		...
		chineseMaxLength:function(value, element, param){
			return this.optional(element) || value.replace(/[^\x00-\xff]/g, 'xx').length <= param;
		}
	}

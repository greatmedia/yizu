    	...
    	<div class="box_zhuce">
			...
			<div class="join">
				<form>
					<ul>
						<li><h1>昵称：</h1></li>
						<li><input type="text" class="text" value="${rname }" id="join_name"/><span class="yes"></span></li>
						<li><h1>电子邮箱：</h1></li>
						<li><input type="text" class="text" value="${remail }" id="join_email"/><span class="yes"></span></li>
						<li><h1>创建密码：</h1></li>
						<li><input type="password" class="text"  id="join_pwd" onkeydown="checkpwd()"/><span class="no" id="checkpwd">密码太过简单，请重新输入。</span></li>
						<li><h1>确认密码：</h1></li>
						<li><input type="password" class="text"  id="join_repwd"/><span class="yes"></span></li>
						<li class="margin"><textarea> 1.	接受条款
...
7).	逸族网对本使用协议享有最终解释权。</textarea ></li>
					...
					<li style="margin-top:14px;margin-left:1px;" id="join_submit"><a id="sub" href="javascript:void(0);" onclick="joinUser()" ></a><span id="loadding" style="display:none;">注册中···</span></li>

...
<%--http://yizu.com:8080/circleInfoAction_update.do?id=56100aff-d7f8-4ddc-aaeb-969b78916dc2--%>
<script src="js/public_min.js" type="text/javascript"></script>
<script src="/js/updatecircle1.js" type="text/javascript"></script>
...
<%--</div>--%>
	<div class="cjqz_right_middle_liangcang">
						<c:forEach var="tag" items="${circletagrelateList}" varStatus="t">
				            ...
				            <dd>
				              <input id="ids${t.index+1 }" type="text"  value="${tag.cirtag.tagname }" />
				            </dd>
				          </dl>
						 </c:forEach>
        				</div>

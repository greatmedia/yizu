...
<script src="js/chuangjianquanzi.js" type="text/javascript"></script>
...
<%--												</c:if>--%>
				...
				<div class="cjqz_right">
					...
					<div class="cjqz_right_middle">
						<%--<div id="catgoryinput" onkeyup="searchTag()" class="cjqz_right_middle_link">--%>
						<%--</div>--%>
						<div class="microGroupTags">
							<%--  selectTag  cjqz_right_middle_link--%>
							<ul class="cjqz_right_middle_link" id="tagsli"
								style="float: left; width: 260px;">
								<li class="newtagsinput" style="width: 120px; background: none;">
									<input type="text" onkeyup="searchTag()" id="newTagsInput"
										class="newtags"
										style="width: 160px; height: 15px; font-size: 14px; background: none;"
										autocomplete="off" value="" />
								</li>
							</ul>
						</div>
						<ul id="searchTag" onmouseout="onmouseoutUL()"
							onmouseover="onmouseoverUL()"
							style="display: none; width: 278px;"></ul>
						<div class="cjqz_right_middle_biaoqian">
							<%--<c:forEach var="tag" items="${circleTags}" varStatus="t">--%>
							<%--   <a href="javascript:void(0);" onclick="tagit(${tag.ctid },'${tag.tagname }')">${tag.tagname }</a>--%>
							<%--</c:forEach>--%>
